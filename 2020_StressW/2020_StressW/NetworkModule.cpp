...
const static int MAX_TEST = MAX_USER / 2;
const static int MAX_CLIENTS = NPC_ID_START;
...
void Test_Thread()
{
	while (true) {
		...
		for (int i = 0; i < num_connections; ++i) {
			...
			case 1: my_packet.direction = 2; break;
			case 2: my_packet.direction = 3; break;
			case 3: my_packet.direction = 1; break;
			}
