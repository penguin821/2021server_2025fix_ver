#pragma once
constexpr int MAX_USER = 210'000;        // 서버내의 최대 객체 개수,  객체 ID의 최대 값
constexpr int MAX_STR_LEN = 50;
constexpr int MAX_ID_LEN = 20;

constexpr int NPC_ID_START = 10'000;	// NPC의 ID가 시작하는 지점, 따라서 플레이어는 0부터 NPC_ID_START까지의 ID를 가짐
					// NPC의 개수는 MAX_USER - NPC_ID_START = 20000,  20만 마리의 NPC가 존재

//========== 추가 ===============
constexpr int MAX_BUFFER = 1024;
constexpr int NPC_AGGRO_START = 150'000;

#define SC_UPDATE		8	// 플레이어 정보 주기적으로 업데이트
//===============================
